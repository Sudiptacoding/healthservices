...
const Footer = () => {
    return (
        <div>
            <footer className="p-10 rounded footer footer-center about-bg text-base-content">
                <nav className="grid grid-flow-col gap-4">
                    <Link to='/about' className="text-white link link-hover">About us</Link>
                    <Link to='/' className="text-white link link-hover">Home</Link>
                    <Link to='/blog' className="text-white link link-hover">Blogs</Link>
                </nav>
                <nav>
